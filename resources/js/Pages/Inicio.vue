...
================================================ -->
        ...
        <div class="row">
          <div class="col-xl-12">
            ...
            <div class="section-headline margin-top-0 margin-bottom-35">
              ...
              <a href="ofertas.html" class="headline-link"
              ...
              <a href="single-job-page.html" class="job-listing">
                ...
                <div class="job-listing-details">
                  ...
                  <div class="job-listing-description">
                    <h4 class="job-listing-company">Edinson Mendez</h4>
                    <h3 class="job-listing-title">
                      Consultor de seguridad informatica
                    </h3>
                    <p class="job-listing-text">
                      Necesito una persona para que me asesore en una cuestion
                      de trabajo puntual, quizas un par de horas. Para analizar
                      un informe tecnico que he desarrollado, pero que tengo
                      dudas en la normativa local.
                    </p>
                  </div>
                ...
                <div class="job-listing-footer">
                  <ul>
                    <li>
                      <i class="icon-material-outline-location-on"></i>Bilbao
                    </li>

                    <li>
                      <i class="icon-material-outline-access-time"></i>Hace 2
                      horas
                    </li>
                  </ul>
                </div>
        ...
        <div class="row">
          <div class="col-xl-12">
            ...
            <div class="section-headline margin-top-0 margin-bottom-25">
              ...
              <a href="autonomo.html" class="headline-link">Ver todos</a>
            </div>
          </div>
                ...
                <div class="freelancer-overview">
                  <div class="freelancer-overview-inner">
                    ...
                    <div class="freelancer-avatar">
                      <div class="verified-badge offline"></div>
                    ...
                    <div class="freelancer-name">
                      <h4>
                        <a href="single-freelancer-profile.html">Tomas Vera </a>
                      </h4>
                ...
                <div class="freelancer-details">
                  <div class="freelancer-details-list">
                    <ul>
                      ...
                      <li>Costo hora <strong>&euro;60 / hr</strong></li>
                    </ul>
                  </div>
                  <a
                ...
                <div class="freelancer-details">
                  <div class="freelancer-details-list">
                    <ul>
                      ...
                      <li>Costo hora <strong>&euro;40 / hr</strong></li>
                    </ul>
                  </div>
                  <a
                    href="single-freelancer-profile.html"
                ...
                <div class="freelancer-details">
                  <div class="freelancer-details-list">
                    <ul>
                      ...
                      <li>Costo hora <strong>&euro;70 / hr</strong></li>
                    </ul>
                  </div>
                  <a
                    href="single-freelancer-profile.html"
                ...
                <div class="freelancer-details">
                  <div class="freelancer-details-list">
                    <ul>
                      ...
                      <li>Costo hora <strong>&euro;80 / hr</strong></li>
                    </ul>
                  </div>
                  <a
                    href="single-freelancer-profile.html"
    ...
    <modalog :errors="errors" :flash="flash" :abremodal="abremodal" :invitado="invitados" />
